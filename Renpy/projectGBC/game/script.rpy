...
# 캐릭터 스프라이트
image isa normal = "images/Char/Isa_Normal.png"
image isa angry = "images/Char/Isa_Angry.png"
image isa happy = "images/Char/Isa_Happy.png"
image isa lookAway = "images/Char/Isa_LookAway.png"
image isa sad = "images/Char/Isa_Sad.png"
image isa smug = "images/Char/Isa_Smug.png"
image isa sneer = "images/Char/Isa_Sneer.png"
image isa surprised = "images/Char/Isa_Surprised.png"
image isa talk = "images/Char/Isa_Talk.png"
image isa think = "images/Char/Isa_Think.png"
...
image solmi happy = "images/Char/Solmi_Happy.png"
image solmi lookAway = "images/Char/Solmi_LookAway.png"
image solmi sad = "images/Char/Solmi_Sad.png"
image solmi smug = "images/Char/Solmi_Smug.png"
image solmi sneer = "images/Char/Solmi_Sneer.png"
image solmi surprised = "images/Char/Solmi_Surprised.png"
image solmi talk = "images/Char/Solmi_Talk.png"
image solmi think = "images/Char/Solmi_Think.png"
image solmi tired = "images/Char/Solmi_Tired.png"
image solmi wink = "images/Char/Solmi_Wink.png"

image daeun normal = "images/Char/Daeun_Normal.png"
image kijun normal = "images/Char/Kijun_Normal.png"
image jaein normal = "images/Char/Jaein_Normal.png"
image dojin normal = "images/Char/Dojin_Normal.png"
...
label s6:
    ...
    show isa normal at left
    show eunbi normal at right
    "동아리방, 황은비, 천이사, 주인공 순서대로 자리에 앉아 있다."

    show isa tired at left
...
label s10:
    ...
    show eunbi sad at right with dissolve
...
label s13:
    ...
    "쾅 하는 소리, 은비가 깜짝 놀란다."
    "동방에 누가 들어왔다."
    show hana tired at center with moveinleft
